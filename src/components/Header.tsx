  ...
  return (
    ...
    <div className={`${comfortaa.variable} w-full bg-white mt-2 p-4`}>
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        {/* Logo */}
       <Link href="/"><p className="text-[22px] font-bold font-comfortaa">Soudemy</p></Link>

     
        <ul className="hidden sm:flex space-x-6 font-bold text-[16px] font-comfortaa">
          <Link href="/Products"><li>Products</li></Link>
          <Link href="/Website"><li>Features</li></Link>
          <Link href="/Customer"><li>Reviews</li></Link>
          <Link href="/Revenue"><li>Pricing</li></Link>
