         ...
         className={`${comfortaa.variable} p-4 flex flex-col justify-center items-center`}>
            ...
            <div className="flex flex-col gap-2 justify-center items-center bg-[#CBE4DE] p-4 mt-4 lg:w-[80%] rounded-md xl:w-[60%]">
                ...
                <div className="flex flex-col justify-center items-center gap-2">
                    ...
                    <p className="text-center font-comfortaa text-[14px] text-gray-700 sm:w-[80%] xl:w-[60%]">We have very fair pricing policy that would benefit you and us at the same time. Choose what price youre willing to pay. Get the free plan & if you need more pay.</p>
